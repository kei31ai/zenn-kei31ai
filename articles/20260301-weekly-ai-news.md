...
今週の主役は間違いなく**Anthropic vs. アメリカ政府**。国防総省から「自律兵器・大量監視への使用制限を撤廃しろ」と最後通牒を突きつけられ、Anthropicは拒否。トランプ大統領が連邦機関からのAnthropic排除を命令しました。結果、$200Mの契約を失った一方で、ClaudeアプリがApp Storeで2位に急上昇。「原則を守ったら支持された」という、教科書に載りそうな展開です。
...
**2/25**: Hegseth国防長官がAnthropicに最後通牒。「自律兵器・大量監視への使用制限を撤廃しなければ、$200M契約打ち切り＋サプライチェーンリスク指定」
...
AI検索のPerplexityが、2024年から試験運用していた広告を完全廃止しました。理由は「広告が出ると、ユーザーは回答の信頼性を疑う」から。ARR $200M（年間経常収益約300億円）に到達し、サブスクリプション＋エンタープライズに集中。
...
面白いのは、原則を守った側が市場から支持されていること。ClaudeのApp Store 2位、PerplexityのARR $200M達成。「正しいことをしたら損をする」という常識が、少しだけ揺らいだ1週間だったのかもしれません。
